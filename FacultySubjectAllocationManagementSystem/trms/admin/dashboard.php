                ...
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="manage-hod.php">Action</a>
                                    
                                </div>
                            </div>
                        </div>
                        <?php 
$sql1 ="SELECT ID from tblhod ";
$query1 = $dbh -> prepare($sql1);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totalHOD=$query1->rowCount();
?>
                        <h4 class="mb-0">
                            <span class="count"><?php echo htmlentities($totalHOD);?></span>
                        </h4>
                        <p class="text-light">Total HODs</p>
                ...
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="manage-dept.php">Action</a>
                                    
                                </div>
                            </div>
                        </div>
                        <?php 
$sql1 ="SELECT ID from tbldepartment ";
$query1 = $dbh -> prepare($sql1);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$totaldept=$query1->rowCount();
?>
                        <h4 class="mb-0">
                            <span class="count"><?php echo htmlentities($totaldept);?></span>
                        </h4>
