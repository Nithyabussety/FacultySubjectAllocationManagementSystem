...
if (strlen($_SESSION['trmsaid']==0)) {
  ...
  {
    $facultyid=$_SESSION['trmsaid'];
    $FName=$_POST['facultyname'];
  $mobno=$_POST['mobilenumber'];
  $email=$_POST['email'];
  $qualification=$_POST['qualifications'];
  $add=$_POST['address'];
  $sql="UPDATE tblteacher set Name=:facultyname,MobileNumber=:mobilenumber,Email=:email, Qualifications=:qualifications, Address=:address where ID=:fid";
     $query = $dbh->prepare($sql);
     $query->bindParam(':facultyname',$FName,PDO::PARAM_STR);
     $query->bindParam(':email',$email,PDO::PARAM_STR);
     $query->bindParam(':mobilenumber',$mobno,PDO::PARAM_STR);
     $query->bindParam(':fid',$facultyid,PDO::PARAM_STR);
...
<head>
    ...
    <title>TRMS Faculty Profile</title>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>Faculty</strong><small> Profile</small></div>
                            <form name="profile" method="post" action="">
                                
                            <div class="card-body card-block">
 <?php
$facultyid=$_SESSION['trmsaid'];
$sql="SELECT Name,UserName,MobileNumber,Email,Qualifications,Address,TeacherSub,JoiningDate,RegDate from tblteacher where ID=$facultyid";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>
                                <div class="form-group"><label for="company" class=" form-control-label">Faculty Name</label><input type="text" name="facultyname" value="<?php  echo $row->Name;?>" class="form-control" required='true'></div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group"><label for="company" class=" form-control-label">Address</label><input type="text" name="address" value="<?php  echo $row->Address;?>" class="form-control" required='true'></div>
                                                     ...
                                                     <div class="col-12">
                                                        ...
                                                        <div class="col-12">
                                                        <div class="form-group"><label for="postal-code" class=" form-control-label">Faculty Joining Date</label><input type="text" name="" value="<?php  echo $row->JoiningDate;?>" readonly="" class="form-control"></div>
                                                        </div>


                                                        <div class="col-12">
                                                        <div class="form-group"><label for="postal-code" class=" form-control-label">Faculty Registration Date</label><input type="text" name="" value="<?php  echo $row->RegDate;?>" readonly="" class="form-control"></div>
                                                        </div>
                                                    </div>
