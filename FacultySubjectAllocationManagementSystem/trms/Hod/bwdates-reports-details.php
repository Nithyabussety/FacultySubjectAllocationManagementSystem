...
$sql="SELECT tblteacher.Name,tblteacher.TeacherSub,tblteacher.RegDate from tblteacher,tblhod where (date(tblteacher.RegDate) between '$fdate' and '$tdate') and tblhod.Id=$session_id and tblhod.DeptId=tblteacher.DeptId ";                                   
