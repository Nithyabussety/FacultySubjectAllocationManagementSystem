...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblhod WHERE Email=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblhod set Password=:newpassword where Email=:email and MobileNumber=:mobile";
